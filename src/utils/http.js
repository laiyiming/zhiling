...
//  axios.defaults.baseURL = 'https://www-test.kdtyun.com';
// } else if (process.env.NODE_ENV == 'debug') {
//  axios.defaults.baseURL = '';
// } else if (process.env.NODE_ENV == 'production') {
// //  axios.defaults.baseURL = 'https://www.kdtyun.com';
// }
...
axios.interceptors.request.use(
  config => {
    ...
    // const token = store.state.token || Cookies.get('remember-me')
...
export function patch(url, params) {
  return new Promise((resolve, reject) => {
    ...
    axios
      .patch(url, QS.stringify(params, { indices: false }))
      .then(res => {
        resolve(res.data);
      })
      .catch(err => {
 ...
 */
export function deletest(url, params) {
  return new Promise((resolve, reject) => {
    axios
      .delete(url, {
        params: params
